...
class ForecastListAdapter(val weekForecast: ForecastList,
    ...
    class ViewHolder(view: View, val itemClick: (Forecast) -> Unit) : RecyclerView.ViewHolder(view) {
        ...
        private val maxTemparatureView = view.find<TextView>(R.id.maxTemperature)
        private val minTemparatureView = view.find<TextView>(R.id.minTemperature)
        ...
        fun bindForecast(forecast: Forecast) {
            with(forecast) {
                ...
                maxTemparatureView.text = "${high}"
                minTemparatureView.text = "${low}"
